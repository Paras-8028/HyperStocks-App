...
/**
 * Renders a label element with default utility classes and allows additional class names.
 *
 ...
 * @returns A `LabelPrimitive.Root` element with merged class names and forwarded props
 */
function Label({
  className,
  ...props
